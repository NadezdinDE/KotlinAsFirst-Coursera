 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = (sagenes * 48.0 * 4.445 + arshins * 48.0 / 3.0 * 4.445 + vershoks * 4.445) / 100
 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = ((sec / 60.0 + min) / 60 + deg) * PI / 180
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial * cube((100 + percent) / 100.0)
